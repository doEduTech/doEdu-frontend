...
import { EducationalPoolFundsDialogComponent } from '@app/pages/users-shared/market/educational-pools/educational-pool-funds-dialog/educational-pool-funds-dialog.component';
